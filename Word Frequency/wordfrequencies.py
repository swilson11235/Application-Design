...
#TO DO:COMMENTS, PYDOC, NICE FORMATTING FOR WORD FREQs
...
def partition(sort_ls):
    ...
    nonalpha_ls = (chr(33), chr(34),chr(35),chr(36),chr(37),chr(38),chr(39),chr(40),chr(41),chr(42),chr(43),chr(44),chr(45),chr(46),chr(47),chr(58),chr(59),chr(63))
    i=0
    for pair in sort_ls:
        for nonalpha in nonalpha_ls: # calls the list of non-alpha characters to remove
